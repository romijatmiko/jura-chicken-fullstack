  ...
  return (
    <CDBFooter className="shadow">
      <CDBBox display="flex" flex="column" className="mx-auto py-5" style={{ width: '90%' }}>
        <CDBBox display="flex" justifyContent="between" className="flex-wrap">
          <CDBBox>
            ...
            <p className="my-3" style={{ width: '250px' }}>
              Nikmati Kelezatan Ayam Jura Chicken, Banyak Menu Dengan Varian Yang Menarik
              Dan Unik, Ayo Segera Pesan Sekarang !!!!
            </p>
        ...
        <small className="text-center mt-5">&copy; JuraChicken, 2022. All rights reserved.</small>
      </CDBBox>
    </CDBFooter>
  );
};